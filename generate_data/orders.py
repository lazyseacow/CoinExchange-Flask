...
order_types = ['market', 'limit', 'stop loss', 'stop profit']
sides = ['buy', 'sell']
symbols = ["BTC/USDT", "ETH/USDT", "LTC/USDT", "ETC/USDT", "XRP/USDT", "BCH/USDT", "TRX/USDT", "XMR/USDT", "DASH/USDT",
           "EOS/USDT", "LINK/USDT", "XLM/USDT", "ZEC/USDT", "UNI/USDT", "DOGE/USDT", "QRL/USDT", "ZUGA/USDT",
           "XTZ/USDT", "IOTA/USDT"]
...
try:
    with connection.cursor() as cursor:
        for i in range(10000):
            ...
            if order_type in ['stop loss', 'stop profit']:
                side = 'sell'
            ...
            cursor.execute(sql, (
                order_type, side, symbol, price, executed_price, quantity, status,
